...
public class FiveStarsHotel {
    ...
    public static void odasecimi() {
        ...
        try {
            ...
            Date d1 = simpleDateFormat.parse(LeptinRunner.girisGunu);
            Date d2 = simpleDateFormat.parse(LeptinRunner.cikisGunu);
    ...
    static void otelFaturaIslemleri() {
        ...
        fiyat = toplamGun * otel.get(odaNo).getGunlukUcret();
                    ...
                    if (kartNo.length() == 4) {
                        ...
                        try {
                            ...
                            if ((sifreler.stream().anyMatch(t -> t.equals(sifre)))) {//sifreyi bankadan cek static sifreler tanimla list te ordan cek lambda match ile
                                ...
                                LeptinRunner.bakiye= (int) (LeptinRunner.bakiye-fiyat);
                                flag = false;
